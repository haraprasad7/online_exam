...
<body>
	...
	%>
				<tr>
					...
					<td> <a href="deleteques_prac.jsp?qno=<%=p.getSlno()%>&sub=<%=request.getParameter("sub")%>">Delete </a> </td>
	...
	<%	
			...
			else
			{
				...
				<tr>
					...
					<td><%=p.getOpt4() %></td>
					<td><%=p.getAns() %></td>
					<td> <a href="updateques_prac.jsp?qno=<%=p.getSlno()%>&sub=<%=request.getParameter("sub")%>">Modify </a> </td>
					<td> <a href="deleteques_prac.jsp?qno=<%=p.getSlno()%>&sub=<%=request.getParameter("sub")%>">Delete </a> </td>
				</tr>
		<%	
			}
